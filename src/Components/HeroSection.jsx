        ...
        {heroSection.map((items,index)=>{
            return (
                <>
                    ...
                    <div key={index} style={{backgroundImage:`linear-gradient(rgba(141, 83, 141,0.5), rgba(141, 83, 141,0.5)), url(${bgImage})`}} className="bg-no-repeat relative heroImg flex contentmax_width h-5/6 my-auto lg:hidden items-center justify-between"> 
